            ...
            <section className={styles["wrapper"]}>
                <article className={styles["top-center"]}>
                    <p>
                        ...
                        на маникюр, педикюр, ноктопластика, кола маска, козметични процедури за лице, миглопластика и микроблейдинг.
                    </p>
                </article>
                ...
                <article className={styles["wrap-text-and-images"]}>
                    ...
                    <div className={styles["wrap-text"]}>
                        <h4>Миглопластика</h4>
                        <p>
                            Удължаването на миглите е идеалният завършек на всяка визия. Индивидуално приложените удължители правят миглите ви да изглеждат по-дълги, 
                            по-плътни и подсилват естествената красота на очите.
                        </p>
                    </div>
                </article>
                <article className={styles["wrap-text-and-images"]}>
