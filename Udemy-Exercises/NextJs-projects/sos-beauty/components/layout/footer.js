    ...
    return (
        <footer className={styles["footer"]}>
            ...
            <div className={`${styles["each-footer-block"]} ${styles["footer-socials"]}`}>
                ...
                <div className={styles["wrap-socials"]}>
                    <div className={styles["see-more"]}>
                        <Link href="https://www.google.com/maps/place/S.O.S+Beauty/@42.137649,24.7864931,19z/data=!4m5!3m4!1s0x14acd1671feabfcf:0xbe40cf6f6dab0e16!8m2!3d42.137649!4d24.7870403">
                            <a className={styles["see-more-text"]} target="_blank">виж повече</a>
                        </Link>
                    </div>
