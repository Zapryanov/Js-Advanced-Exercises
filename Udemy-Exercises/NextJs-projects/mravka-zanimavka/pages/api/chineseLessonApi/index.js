function handler(req, res) {
    if (req.method === "POST") {
        ...
        fetch(`https://mravka-zanimavka-default-rtdb.europe-west1.firebasedatabase.app/lessons/chineseLessons.json?auth=${accessToken}`, {
                method: "POST",
            ...
            .then(data => console.log("The lesson is added from api/chineseLessonApi - ", data))
